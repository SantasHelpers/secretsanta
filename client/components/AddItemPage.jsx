...
var AddItemPage = observer(class AddItemPage extends React.Component {
  ...
  render() {
    return (
     <div>
      <div>
        <h2>Add some items to your backet</h2>
        <br/>
        <h5>Tell Santa what you want</h5>
        <input type="text" name="keyword" ref="keyword" size="50"/>
        <br/>
        <Button bsStyle="success" name="button" onClick={this.onButtonClick.bind(this)}>Search for Gifts</Button>
        <br/>
        <ItemSearchBox />
      </div>
     </div>
